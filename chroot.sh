...
pacman-key --add /usr/share/pacman/keyrings/ctlos.gpg && sudo pacman-key --lsign-key 50417293016B25BED7249D8398F76D97B786E6A3
...
# sed -i 's?GRUB_DISTRIBUTOR=.*?GRUB_DISTRIBUTOR=\"Ctlos Linux\"?' /etc/default/grub
# sed -i 's?\#GRUB_THEME=.*?GRUB_THEME=\/boot\/grub\/themes\/Stylish\/theme.txt?g' /etc/default/grub
